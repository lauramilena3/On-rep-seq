...
rule correctReads:
	...
	shell:
		...
		do
			echo $line
			./canu/canu-1.8/Linux-amd64/bin/canu -correct -p peak -d {params}/fixed_$line genomeSize=5k -nanopore-raw {params}/$line.fastq minReadLength=300 correctedErrorRate=0.01 corOutCoverage=5000 corMinCoverage=2 minOverlapLength=300 cnsErrorRate=0.1 cnsMaxCoverage=5000 useGrid=false || true
